...
install -m 0755 "$SOURCE_ROOT/lib/executor-completion.cjs" "$INSTALL_HOME/lib/executor-completion.cjs"
install -m 0755 "$SOURCE_ROOT/lib/evidence-sanitizer.cjs" "$INSTALL_HOME/lib/evidence-sanitizer.cjs"
install -m 0755 "$SOURCE_ROOT/lib/evidence-provenance.cjs" "$INSTALL_HOME/lib/evidence-provenance.cjs"
install -m 0755 "$SOURCE_ROOT/lib/release-identity.cjs" "$INSTALL_HOME/lib/release-identity.cjs"
...
install -m 0755 "$SOURCE_ROOT/lib/execution-identity.cjs" "$INSTALL_HOME/lib/execution-identity.cjs"
...
install -m 0644 "$SOURCE_ROOT/RB-RALPH-CONTRACT-IDENTITY.json" "$INSTALL_HOME/RB-RALPH-CONTRACT-IDENTITY.json"
