...
const BUILT_INS = Object.freeze({
  balanced: {
    description: "Fresh task calls, delivery review, exhaustive audit matrix, final audit, dashboard, and YOLO permissions.",
    execution: {
      unit: "task",
      managerAudit: "exhaustive",
      managerReview: "delivery",
      finalAudit: true,
      dashboard: true,
      permissionMode: "yolo",
    },
  ...
  fast: {
    description: "One fresh call per phase with delivery review, final audit, dashboard, and YOLO permissions.",
    execution: {
      unit: "phase",
      managerAudit: "exhaustive",
      managerReview: "delivery",
  ...
  strict: {
    description: "Fresh task calls, full code review, exhaustive audit matrix, final audit, dashboard, and protected provider permissions.",
    execution: {
      unit: "task",
      managerAudit: "exhaustive",
      managerReview: "code",
...
function validateExecution(value) {
  ...
  const allowed = new Set([
    "unit", "managerAudit", "managerReview", "validationMode", "finalAudit", "dashboard",
  ...
  if (value.managerReview !== undefined) {
    if (!["delivery", "code"].includes(value.managerReview)) fail("profile.execution.managerReview must be delivery or code");
    execution.managerReview = value.managerReview;
  }
...
function profileArgs(profile) {
  ...
  if (execution.managerReview) args.push("--manager-review", execution.managerReview);
...
function argsToProfile(args) {
  ...
  const valueFlags = new Map([
    ...
    ["--manager-review", ["execution", "managerReview"]],
